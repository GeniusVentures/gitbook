# Pedersen Commitments Pairs for Blinding Factors and Values
...
* &#x20;and  are the public generators of the group  is the blinding factor  is the value to be committed
...
* &#x20;and  are the public generators of the group  is the value to be committed  is the blinding factor

## 2. Integration of PCBF and PCValue in Cryptographic Systems
...
* Calculate the new value: Determine the updated value  by adding the original value  to the new value .
* Create the updated PCValue commitment: Use the blinding factor  and the new value  to create the updated PCValue commitment .  is added to  with the Pedersen addMod function.

## 2.3 Opening the Updated Commitment
...
* Decode the blinding factor: Use  and  to decode the updated blinding factor .
* Calculate the value: Once  is known, use it to calculate the stored value v from  and .
...
## 2.4 Enhanced Blinding Using Key Derivation Function and Ethereum Public Keys

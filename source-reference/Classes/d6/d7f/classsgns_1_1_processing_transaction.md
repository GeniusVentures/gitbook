---
title: sgns::ProcessingTransaction
...
|                | Name           |
| -------------- | -------------- |
| std::shared_ptr< [ProcessingTransaction](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-processingtransaction) > | **[DeSerializeByteVector](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-deserializebytevector)**(const std::vector< uint8_t > & data) |
| [ProcessingTransaction](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-processingtransaction) | **[New](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-new)**(std::string job_id, std::vector< std::string > subtask_ids, std::vector< std::string > node_addresses, SGTransaction::DAGStruct dag) |
| | **[~ProcessingTransaction](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-~processingtransaction)**() override =default |
| virtual EmbeddedTransaction | **[SerializeToEmbeddedTransaction](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-serializetoembeddedtransaction)**(const SGTransaction::DAGStruct & dag) const override<br/>Serializes the transaction into an EmbeddedTransaction proto with the appropriate oneof field set.  |
| virtual std::vector< uint8_t > | **[SerializeByteVector](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-serializebytevector)**(const SGTransaction::DAGStruct & dag) const override<br/>Serializes the transaction into a byte vector, including the DAG metadata.  |
| uint256_t | **[GetJobHash](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-getjobhash)**() const |
| std::vector< std::string > | **[GetSubtaskIDs](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-getsubtaskids)**() const |
| std::vector< std::string > | **[GetNodeAddresses](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-getnodeaddresses)**() const |
| std::string | **[GetTaskID](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-gettaskid)**() const |
| virtual std::string | **[GetTransactionSpecificPath](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-gettransactionspecificpath)**() const override<br/>Returns the transaction-specific path component for storage and retrieval.  |
| std::vector< uint8_t > | **[SerializeByteVector](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-serializebytevector)**() const<br/>Serializes the transaction using the internal DAG metadata.  |
| EmbeddedTransaction | **[SerializeToEmbeddedTransaction](/source-reference/Classes/d6/d7f/classsgns_1_1_processing_transaction/#function-serializetoembeddedtransaction)**() const<br/>Serializes using internal DAG metadata.  |

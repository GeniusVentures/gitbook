---
title: sgns::AppleSecureStorage

---

# sgns::AppleSecureStorage
...
|                | Name           |
| -------------- | -------------- |
| | **[AppleSecureStorage](/source-reference/Classes/d9/d1f/classsgns_1_1_apple_secure_storage/#function-applesecurestorage)**(std::string identifier) |
| virtual std::string | **[GetName](/source-reference/Classes/d9/d1f/classsgns_1_1_apple_secure_storage/#function-getname)**() override |
| virtual outcome::result< rapidjson::Document > | **[LoadJSON](/source-reference/Classes/d9/d1f/classsgns_1_1_apple_secure_storage/#function-loadjson)**() const override |
| virtual outcome::result< void > | **[SaveJSON](/source-reference/Classes/d9/d1f/classsgns_1_1_apple_secure_storage/#function-savejson)**(rapidjson::Document document) override |
...
### function AppleSecureStorage

```cpp
explicit AppleSecureStorage(

---
title: sgns::MigrationTransaction
...
|                | Name           |
| -------------- | -------------- |
| virtual EmbeddedTransaction | **[SerializeToEmbeddedTransaction](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-serializetoembeddedtransaction)**(const SGTransaction::DAGStruct & dag) const override<br/>Serializes the transaction into an EmbeddedTransaction proto with the appropriate oneof field set.  |
| | **[~MigrationTransaction](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-~migrationtransaction)**() override =default |
| virtual std::vector< uint8_t > | **[SerializeByteVector](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-serializebytevector)**(const SGTransaction::DAGStruct & dag) const override<br/>Serializes the transaction into a byte vector, including the DAG metadata.  |
| uint64_t | **[GetAmount](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-getamount)**() const |
| [TokenID](/source-reference/Classes/d9/dd1/classsgns_1_1_token_i_d/) | **[GetTokenID](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-gettokenid)**() const |
| virtual std::string | **[GetChainId](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-getchainid)**() const override<br/>Returns the source chain id for input validation routing.  |
| [UTXOTxParameters](/source-reference/Namespaces/d2/d2b/namespacesgns/#using-utxotxparameters) | **[GetUTXOParameters](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-getutxoparameters)**() const |
| virtual bool | **[HasUTXOParameters](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-hasutxoparameters)**() const override<br/>Returns if transaction supports UTXOs.  |
| virtual std::optional< [UTXOTxParameters](/source-reference/Namespaces/d2/d2b/namespacesgns/#using-utxotxparameters) > | **[GetUTXOParametersOpt](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-getutxoparametersopt)**() const override<br/>Returns the UTXOs.  |
| std::string | **[GetFromVersion](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-getfromversion)**() const |
| virtual std::string | **[GetTransactionSpecificPath](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-gettransactionspecificpath)**() const override<br/>Returns the transaction-specific path component for storage and retrieval.  |
| virtual std::unordered_set< std::string > | **[GetTopics](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-gettopics)**() const override<br/>Returns the destination topics associated with the transaction.  |
| std::vector< uint8_t > | **[SerializeByteVector](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-serializebytevector)**() const<br/>Serializes the transaction using the internal DAG metadata.  |
| EmbeddedTransaction | **[SerializeToEmbeddedTransaction](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-serializetoembeddedtransaction)**() const<br/>Serializes using internal DAG metadata.  |
| std::shared_ptr< [MigrationTransaction](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-migrationtransaction) > | **[DeSerializeByteVector](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-deserializebytevector)**(const std::vector< uint8_t > & data) |
| [MigrationTransaction](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-migrationtransaction) | **[New](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-new)**(uint64_t amount, std::string from_version, [TokenID](/source-reference/Classes/d9/dd1/classsgns_1_1_token_i_d/) token_id, SGTransaction::DAGStruct dag, std::string destination ="") |
| std::string | **[DeriveUniqueSourceKey](/source-reference/Classes/d3/d30/classsgns_1_1_migration_transaction/#function-deriveuniquesourcekey)**(std::string_view from_version, std::string_view source_address, const [TokenID](/source-reference/Classes/d9/dd1/classsgns_1_1_token_i_d/) & token_id) |
